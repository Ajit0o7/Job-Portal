<?php
    ...
    // Retrieve and process top user skills data
    $sql = "SELECT * FROM seekerresume";
    $result = $conn->query($sql);
    $skillsDemand = [];

    if ($result && $result->num_rows > 0) {
        while ($job = $result->fetch_assoc()) {
            $jobSkills = explode(', ', $job['skill']);
...
<head>
    ...
    <title>Top User Skills | JobPortal Admin</title>
    <!-- Fonts and Icons -->
...
<body class="top-user-skills-page">
    <div class="navforadmin">
        ...
        <a class="navstyle navactive" href="topuserskills"><i class="fas fa-graduation-cap"></i> Top User Skills</a>
    </div>

    <div class="admin-container">
        <div class="page-header">
            <h1>Top User Skills</h1>
            <p>Analyze the primary core skills submitted by job seekers in their resume profiles.</p>
        </div>
        ...
        <div class="chart-card">
            <div class="chart-container">
                ...
                if (!empty($skillsDemand)) {
                    ...
                    echo "<p style='text-align: center; color: #64748b; padding: 20px;'>No user skill data available.</p>";
                }
                ?>
            </div>
        </div>
