<?php
    ...
    $fetch = "SELECT * FROM `job_postings` where   `job_id` = '$_REQUEST[s_id]'";
    ...
    <?php include 'logout.php'; ?>
        ...
        <a class="navstyle " href="topuserskills"><i class="fas fa-graduation-cap"></i> Top User Skills</a>
            ...
            <div class="removeproperty">
                ...
                <div class="job-card">
                        <p><span style="font-weight:bold;">Post Title:</span> <?php echo $output['title']; ?></p>
                        <p><span style="font-weight:bold;">Requirements:</span> <?php echo $output['requirements']; ?></p>
                        <p><span style="font-weight:bold;">Skills:</span> <?php echo $output['skills']; ?></p>
                        <p><span style="font-weight:bold;">Description:</span><?php echo $output['description']; ?></p>
                        <p><span style="font-weight:bold;">Salary:</span> <?php echo $output['salary']; ?></p>
                        <p><span style="font-weight:bold;">Date Posted:</span> <?php echo $output['date_posted']; ?></p>
                    <a href="delete?s_id=<?php echo $output['job_id']?>"><button style="background-color:red;color:white;font-size:22px;border-radius:5px;margin-left:40%;margin-top:25px;">Remove</button></a>
                </div>
            </div>
        </div>
    </body>
